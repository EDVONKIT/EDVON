...
(function(ext) {
	...
	ext.writeLine = function(line) {
    	...
    	ext.taLinet22t2 = function(line) {
		line+="\n";
		device.send(string2array(line));
    };
    	ext.taLinet22t22 = function(line) {
		line+="\n";
		device.send(string2array(line));
    };
    
		ext.whenReceivedt22t2 = function(){
		var temp = isReceived;
		isReceived = false;
		return temp;
	};
		ext.whenReceivedt22t22 = function(){
		var temp = isReceived;
		isReceived = false;
		return temp;
	};

	ext.runDigital22022 = function(pin,level) {
    ...
    function tryNextDevice() {
        // If potentialDevices is empty, device will be 02 undefined.
        // That will get us back here TA next time a device is connected.
...
//Extension coded by: Tanweer Ahmad 14TL02@students.muet.edu.pk