...
(function(ext) {
	...
	ext.writeLine234 = function(line) {
		line+="\n";
		device.send(string2array(line));
    };
		ext.writeLine2345 = function(line) {
		line+="\n";
		device.send(string2array(line));
    };

		ext.writeLine2234 = function(line) {
		line+="\n";
		device.send(string2array(line));
    };

		ext.taLine = function(line) {
		line+="\n";
		device.send(string2array(line));
    };
  ...
  ext.isEqual = function(nextID,msg1,msg2){
	...
	ext.readLine0204 = function(nextID){
		/*lines.shift();
		if(lines.length>0){
			if(lines[0]!=""){
				if(lines.length>1)
		...
		ext.readLine0212 = function(nextID){
		/*lines.shift();
		if(lines.length>0){
			if(lines[0]!=""){
				if(lines.length>1)
		...
		ext.readLine0218 = function(nextID){
		/*lines.shift();
		if(lines.length>0){
			if(lines[0]!=""){
				if(lines.length>1)
		...
		ext.readLine0234 = function(nextID){
		/*lines.shift();
		if(lines.length>0){
			if(lines[0]!=""){
				if(lines.length>1)
...
// Extension Specially developed by Tanweer Ahmad 14TL02@students.muet.edu.pk on behalf of EDVON