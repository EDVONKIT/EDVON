...
(function(ext) {
	...
	ext.writeLine02 = function(line) {
		line+="\n";
		device.send(string2array(line));
    };
	
		ext.writeLine04 = function(line) {
		line+="\n";
		device.send(string2array(line));
    };
  ...
  ext.isEqual = function(nextID,msg1,msg2){
	...
	ext.readLineak02 = function(nextID){
		/*lines.shift();
		if(lines.length>0){
			if(lines[0]!=""){
				if(lines.length>1)
		...
		ext.readLineak04 = function(nextID){
		/*lines.shift();
		if(lines.length>0){
			if(lines[0]!=""){
				if(lines.length>1)
		...
		ext.readLineak12 = function(nextID){
		/*lines.shift();
		if(lines.length>0){
			if(lines[0]!=""){
				if(lines.length>1)
		...
		ext.readLineak34 = function(nextID){
		/*lines.shift();
		if(lines.length>0){
			if(lines[0]!=""){
				if(lines.length>1)
...
//Extension specifically created by Tanweer Ahmad, 14TL02@students.muet.edu.pk on behalf of EDVON.