package util
{
	...
	public class ClickerManager
	{
		...
		public function update():void{
			...
			urlloader.load(new URLRequest("http://download.edvolution.com/mblock/resources/click"+(ApplicationManager.sharedManager().isCatVersion?"_myh":"")+".txt?time="+Math.floor(new Date().time/100000)));
		}
